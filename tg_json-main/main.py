...
# для установки на сервер необходимо в файл requirements.text добавить строку
# 'PyTelegramBotApi'
from telebot import TeleBot, types
import json

bot = TeleBot(token='6080912934:AAFdoR0iPUUa926J8xM0_8xYMM3sdxl2qFk', parse_mode='html') # создание бота
